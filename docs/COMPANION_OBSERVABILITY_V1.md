...
A persistent sink and optional external provider adapter still require a separate implementation, with retention/privacy enforcement and acceptance evidence. This seam is therefore not evidence of production telemetry delivery or external provider ingestion.
