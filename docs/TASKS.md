...
- [~] Device Details revoke/rotate: backend endpoints уже существовали; Android UI/actions добавлены в этом PR, revoke очищает локальную session и возвращает на Login. Закрыть после CI evidence этого PR.
