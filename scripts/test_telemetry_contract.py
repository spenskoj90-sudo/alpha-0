...
class TelemetryContractTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.app_strings = read("app/src/main/java/com/alpha0/app/ui/AppStrings.kt")
    ...
    def test_user_ticket_diagnostics_require_explicit_consent_and_remain_bounded(self) -> None:
        ...
        self.assertIn('strings.text("attach_diagnostics")', self.quality_screen)
        self.assertIn('strings.text("quality_program_opt_in")', self.quality_screen)
        self.assertIn("Attach this diagnostic snapshot to my report", self.app_strings)
        self.assertIn("Contribute this report to SENTINEL quality improvement", self.app_strings)
