...
def check_versions(checks: Checks) -> None:
    ...
    checks.require(web_package.get("dependencies", {}).get("next") == "16.3.5", "Web pins Next.js 16.3.5")
    ...
    checks.require(launcher.get("dependencies", {}).get("electron") == "44.4.2", "Launcher pins Electron 44.4.2")
    checks.require(launcher.get("sentinelPackaging", {}).get("electronVersion") == "44.4.2", "Launcher packaging pins Electron 44.4.2")
