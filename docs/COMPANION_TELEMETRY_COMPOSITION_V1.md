...
Provide a small composition seam that lets the Companion runtime use its existing local telemetry sink alone or fan out the same privacy-safe event to an optional persistent sink.
