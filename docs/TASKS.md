...
`Verified foundation → Block B productization → Companion/launcher/WoW runtime → player/voice UX → observability/performance runtime → Owner/external release gates`
