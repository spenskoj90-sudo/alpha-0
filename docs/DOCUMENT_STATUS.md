...
- `SENTINEL_EVIDENCE_PROTOCOL.md`, `RELEASE_GATES.md`, `RELEASE_EVIDENCE_PREFLIGHT_V1.md` and `SUPPLY_CHAIN_EVIDENCE_V1.md` — active evidence and release-acceptance contracts.
